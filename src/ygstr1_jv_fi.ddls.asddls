...
define view entity YGSTR1_JV_FI as
   select distinct from    I_OperationalAcctgDocItem as a
   ...
   left outer join I_JournalEntry   as       f on f.CompanyCode        = a.CompanyCode
                                                   ...
                                                   and ( f.IsReversed = ' ' and f.IsReversal = ' ' )
...
where
  ...
  and ( b.TransactionCode  like 'FB%')
  and ( b.TransactionCode  != 'FB60' or 
        b.TransactionCode  != 'FB65' ) 
     
  and ( a.AccountingDocumentItemType = 'T' )
  
  and ( a.TransactionTypeDetermination = 'JOC' or
...
//  and   ( a.TransactionTypeDetermination = 'JOC' or
//          a.TransactionTypeDetermination = 'JOS' or
//          a.TransactionTypeDetermination = 'JOI' or 
//          a.TransactionTypeDetermination = '' )
